...
export const Home = () => {
    return (
        <>
        <Navbar/>
        <div  className="bg-test2 h-screen w-screen flex justify-center"> 

             <div className="max-w-4xl flex flex-col items-center space-y-4">
                <h1 className="text-test3 font-bold text-8xl mt-40 text-center">Welocome to<br/>Food Focus</h1>
                <Button className="bg-test4 w-1/4 h-16 font-bold text-xl"> Get Started </Button>
